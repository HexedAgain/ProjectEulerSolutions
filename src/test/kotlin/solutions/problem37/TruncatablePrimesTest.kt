...
class TruncatablePrimesTest {
    ...
    fun `bothWayTruncatablePrimes, if max prime is zero or negative, it returns emptyList`() {
        assertEquals(emptyList<Int>(), TruncatablePrimes(primesUpto = 0).getBothWayTruncatablePrimes3())
        assertEquals(emptyList<Int>(), TruncatablePrimes(primesUpto = -123).getBothWayTruncatablePrimes3())
    }
    @Test
    fun `bothWayTruncatablePrimes, if max prime is less than 23, it returns emptyList`() {
        (1 until 23).forEach {
            assertEquals(emptyList<Int>(), TruncatablePrimes(primesUpto = it).getBothWayTruncatablePrimes3())
        }
    }

    @Test
    fun `bothWayTruncatablePrimes, if max prime is equal to 23, it returns list (23)`() {
        val result = TruncatablePrimes(primesUpto = 23).getBothWayTruncatablePrimes3()
    ...
    fun `bothWayTruncatablePrimes, if max prime is 37, it returns list (23, 37)`() {
        val result = TruncatablePrimes(primesUpto = 37).getBothWayTruncatablePrimes3()
    ...
    fun `bothWayTruncatablePrimes, if max prime is 100, it returns list (23, 37, 53, 73)`() {
        val result = TruncatablePrimes(primesUpto = 100).getBothWayTruncatablePrimes3()
    ...
    fun `bothWayTruncatablePrimes, if max prime is 1000_000, it returns list (23, 37, 53, 73, 313, 317, 373, 797, 3137, 3797, 739397)`() {
        val result = TruncatablePrimes(primesUpto = 1000_000).getBothWayTruncatablePrimes3()
